...
namespace Chapter03StepByStep {
    ...
    public partial class PubsDataSet : global::System.Data.DataSet {
        ...
        private void InitExpressions() {
            this.employee.FullNameColumn.Expression = "lname + \', \' + fname";
        }
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public employeeRow AddemployeeRow(string emp_id, string fname, string lname, System.DateTime hire_date, string FullName) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public employeeRow AddemployeeRow(string emp_id, string fname, string lname, System.DateTime hire_date) {
                employeeRow rowemployeeRow = ((employeeRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        emp_id,
                        fname,
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            private void InitExpressions() {
                this.FullNameColumn.Expression = "lname + \', \' + fname";
            }
...
namespace Chapter03StepByStep.PubsDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[employee] WHERE (([emp_id] = @Original_emp_id) AND ([fname] = " +
                "@Original_fname) AND ([lname] = @Original_lname) AND ([hire_date] = @Original_hi" +
                "re_date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employee] ([emp_id], [fname], [lname], [hire_date]) VALUES (@e" +
                "mp_id, @fname, @lname, @hire_date);\r\nSELECT emp_id, fname, lname, hire_date FROM" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employee] SET [emp_id] = @emp_id, [fname] = @fname, [lname] = @lname, [hire_date] = @hire_date WHERE (([emp_id] = @Original_emp_id) AND ([fname] = @Original_fname) AND ([lname] = @Original_lname) AND ([hire_date] = @Original_hire_date));
SELECT emp_id, fname, lname, hire_date FROM employee WHERE (emp_id = @emp_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Chapter03StepByStep.Properties.Settings.Default.PubsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT emp_id, fname, lname, hire_date FROM employee";
        ...
        public virtual PubsDataSet.employeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PubsDataSet.employeeDataTable dataTable = new PubsDataSet.employeeDataTable(true);
        ...
        public virtual int Delete(string Original_emp_id, string Original_fname, string Original_lname, System.DateTime Original_hire_date) {
        ...
        public virtual int Insert(string emp_id, string fname, string lname, System.DateTime hire_date) {
            if ((emp_id == null)) {
        ...
        public virtual int Update(string emp_id, string fname, string lname, System.DateTime hire_date, string Original_emp_id, string Original_fname, string Original_lname, System.DateTime Original_hire_date) {
            if ((emp_id == null)) {
                throw new global::System.ArgumentNullException("emp_id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, string lname, System.DateTime hire_date, string Original_emp_id, string Original_fname, string Original_lname, System.DateTime Original_hire_date) {
            return this.Update(Original_emp_id, fname, lname, hire_date, Original_emp_id, Original_fname, Original_lname, Original_hire_date);
        }
    }
