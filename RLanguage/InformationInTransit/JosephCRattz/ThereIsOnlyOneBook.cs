...
namespace bible
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="bible")]
    ...
    partial void InsertScriptureRevised(ScriptureRevised instance);
    partial void UpdateScriptureRevised(ScriptureRevised instance);
    partial void DeleteScriptureRevised(ScriptureRevised instance);
    ...
    partial void DeleteWorldWould(WorldWould instance);
		...
		public System.Data.Linq.Table<ScriptureRevised> ScriptureRevised
		{
			get
			{
				return this.GetTable<ScriptureRevised>();
			}
		}
    ...
    partial void OnUriChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_KingJamesVersion", DbType="VarChar(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AmericanStandardBible", DbType="VarChar(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_YoungLiteralTranslation", DbType="VarChar(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ScriptureRevised")]
	public partial class ScriptureRevised : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnUriChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="bookTitle", Storage="_BookTitle", AutoSync=AutoSync.Always, DbType="VarChar(30)", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never, Expression="(CONVERT([varchar](30),[dbo].[udf_BookTitle]([bookID]),0))")]
		public string BookTitle
		{
			get
			{
