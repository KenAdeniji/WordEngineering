...
/*
2014-02-26 	http://www.apress.com/9781430245964 ZIPCodes.cs File created, work begun. ZIPCodes.txt not found.
*/
namespace InformationInTransit.ProcessLogic
{
    public static partial class ZIPCodes
    {
        static string sqlconnection = "DATA SOURCE=(local); " +
          "INITIAL CATALOG=Generative; " +
          "INTEGRATED SECURITY=SSPI;";

        static string sourcefile = @"ZIPCodes.txt";
