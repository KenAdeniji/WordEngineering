...
{
    /*
        2016-06-13	BibleStatisticsOppositeHelper.cs 		Created.
    */
    public static partial class BibleStatisticsOppositeHelper
    {
		...
		{ 
			new string[] {"Heaven", "Earth"},
			new string[] {"Day", "Night"},
			new string[] {"Evening", "Morning"},
			new string[] {"Earth", "Seas"},
			new string[] {"Sun", "Moon"},
			new string[] {"Male", "Female"},
			new string[] {"Bless", "Curse"}, //2016-11-18 Penalties and prizes. Bless and curse.
			new string[] {"Left", "Right"}, //2016-12-11
			new string[] {"First", "Last"} //2016-12-11
		};		
