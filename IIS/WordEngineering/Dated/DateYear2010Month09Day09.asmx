<%@ WebService Language="C#" Class="DateYear2010Month09Day09WebService" %>
...
*/
///<summary>
///	2025-03-12T04:42:00 Created.
///</summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
[ScriptService]
public class DateYear2010Month09Day09WebService : System.Web.Services.WebService
{
   	[WebMethod]
	...
	public const String DatePatternFullMatch = @"^\d{1,4}\-\d{1,2}-\d{1,2}$";
	public const String DatePatternPartialMatch = @"\d{1,4}\-\d{1,2}-\d{1,2}";	
}
