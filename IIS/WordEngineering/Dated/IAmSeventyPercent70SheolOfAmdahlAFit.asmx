<%@ WebService Language="C#" Class="IAmSeventyPercent70SheolOfAmdahlAFitWebService" %>
...
*/
///<summary>
///	2025-03-15T23:29:00 I am seventy percent, 70%, Sheol of Amdahl a fit.
///	2025-03-16T18:43:00...2025-03-16T18:55:00 Created.
///</summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
[ScriptService]
public class IAmSeventyPercent70SheolOfAmdahlAFitWebService : System.Web.Services.WebService
{
   	[WebMethod]
	...
	)
    {
		...
		DataTable filterTable = 
			...
			(
				...
				(
					row["Word"].ToString(),
					partialMatch ? PercentPatternPartialMatch : PercentPatternFullMatch
				)
			)
			.CopyToDataTable();	
	...
	public const String PercentPatternFullMatch = @"^\d+\%$";
	public const String PercentPatternPartialMatch = @"\d+\%";	
}
