...
public partial class MyWord : System.Web.UI.Page
{
	...
	protected void MyWordGridView_Sorting(object sender, GridViewSortEventArgs e)
    {
        DataTable dataTable = (DataTable)ViewState["myWordGridView"];
        if (dataTable != null)
        {
            myWordGridView.DataSource = dataTable;
            myWordGridView.Sort(e);
        }
	}
 	...
 	protected void Submit_Click(object sender, EventArgs e)
    {
		...
		ViewState["myWordGridView"] = dataTable;
		myWordGridView.DataSource = dataTable;
		myWordGridView.DataBind();
    }
}
