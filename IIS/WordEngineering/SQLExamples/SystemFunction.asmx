...
UNION SELECT 'HOST_NAME()' AS Question, HOST_NAME() AS Answer
UNION SELECT 'SYSTEM_USER' AS Question, SYSTEM_USER AS Answer
UNION SELECT 'USER' AS Question, USER AS Answer
ORDER BY Question
";
}
