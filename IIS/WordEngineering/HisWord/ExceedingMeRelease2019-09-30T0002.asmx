...
public class ExceedingMeWebService : System.Web.Services.WebService
{
	...
	)
    {
		...
		dynamic jsonObject = (JObject) JValue.Parse(jsonInput);
		...
		foreach (var property in jsonObject)
		{
			...
			whereClause += jsonObject[property] + " LIKE '%" + jsonObject[property].Value + "%'";
		}
		...
		string sqlStatement = "SELECT * FROM " +
			String.Format(SQLSource, databaseName, schemaName, tableName) +
