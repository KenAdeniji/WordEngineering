...
var data = ajaxfetch('/WordEngineering/ChristianHeilmann.com/SongSearch/songs.csv');

})();

if('serviceWorker' in navigator) {
  navigator.serviceWorker.register('/WordEngineering/ChristianHeilmann.com/SongSearch/songsearch-sw.js', { scope: '/WordEngineering/ChristianHeilmann.com/SongSearch/' })
