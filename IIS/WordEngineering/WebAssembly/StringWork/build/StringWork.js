...
var wasmBinaryFile = 'StringWork.wasm';
...
// {{PRE_LIBRARY}}
  ...
  Module["flush_NO_FILESYSTEM"] = flush_NO_FILESYSTEM;function _fd_write(fd, iov, iovcnt, pnum) {try {
...
var asmGlobalArg = {};
var asmLibraryArg = { "__cxa_atexit": ___cxa_atexit, "args_get": _args_get, "args_sizes_get": _args_sizes_get, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "fd_close": _fd_close, "fd_seek": _fd_seek, "fd_write": _fd_write, "proc_exit": _proc_exit };
var asm = createWasm();
var real__getResultSet = asm["getResultSet"];
asm["getResultSet"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getResultSet.apply(null, arguments);
};
...
Module["asm"] = asm;
var _getResultSet = Module["_getResultSet"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["getResultSet"].apply(null, arguments)
};
