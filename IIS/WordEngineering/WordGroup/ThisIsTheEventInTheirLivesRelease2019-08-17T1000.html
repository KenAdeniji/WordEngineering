		...
		<script>
			...
			function buildSelect(columnName)
			{
				...
				({
					...
					url: "/WordEngineering/TheSpanishHaveQuitResemblingNow/ThisIsTheEventInTheirLives.asmx/QueryMenu",
					data: requestJson,
					dataType: "json",
			...
			function querySubmit()
			{
				...
				({
					type: "POST",
					contentType: "application/json; charset=utf-8",
					url: "/WordEngineering/TheSpanishHaveQuitResemblingNow/ThisIsTheEventInTheirLives.asmx/QueryDated",
					data: requestJson,
					dataType: "json",
					success: function (data) {
