...
namespace Lab_Assignment_3.NorthwindDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab_Assignment_3.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        public virtual NorthwindDataSet.CustomersDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            NorthwindDataSet.CustomersDataTable dataTable = new NorthwindDataSet.CustomersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
