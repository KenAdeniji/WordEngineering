...
git add        GitHub.com/2021-03-26T1328gitadd.bat
git add        GitHub.com/2021-03-26T1328gitaddArchive.bat
git add        GitHub.com/2021-03-27T1824gitadd.bat
git add        GitHub.com/2021-03-27T1824gitaddArchive.bat

git add        IIS/WordEngineering/WordGroup/WhenGoodThingsHappen.asmx
git add        IIS/WordEngineering/WordGroup/WhenGoodThingsHappen.html
git add        IIS/WordEngineering/WordGroup/WhenGoodThingsHappenArchive.asmx
git add        IIS/WordEngineering/WordGroup/WhenGoodThingsHappenArchive.html
git add        InformationInTransit/ProcessCode/WhenGoodThingsHappen.Archivecs
git add        InformationInTransit/ProcessCode/WhenGoodThingsHappen.cs
