        ...
        git add   IIS/WordEngineering/WordUnion/ScriptureReferenceWebServiceArchive.asmx
...
git add        GitHub.com/2022-01-15T1124GitHub.bat
git add        IIS/WordEngineering/WordCross/WhatIsThisTheOneCarryingWhatIsThisYouWantMeToDo.html
git add        IIS/WordEngineering/WordCross/WhatIsThisTheOneCarryingWhatIsThisYouWantMeToDoArchive.html
