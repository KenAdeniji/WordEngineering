...
git add        GitHub.com/2021-11-08T1309GitHub.bat
git add        GitHub.com/2021-11-08T1309GitHubArchive.bat
git add        IIS/WordEngineering/WordCross/DiscoverPowerShell.asmx
git add        IIS/WordEngineering/WordCross/DiscoverPowerShell.html
git add        IIS/WordEngineering/WordCross/DiscoverPowerShellArchive.asmx
