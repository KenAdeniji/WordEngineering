...
git add        Java/deprecate/
git add        Java/mssql-jdbc-10.2.0.jre17.jar
git add        Java/mssql-jdbc_auth-10.2.0.x64.dll
git add        Java/mssql-jdbc_auth-10.2.0.x86.dll
git add        Java/run.cmd
git add        Java/runArchive.cmd
git add        Java/uiswing/
