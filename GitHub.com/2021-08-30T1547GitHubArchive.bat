...
git add        GitHub.com/2021-08-30T1547GitHub.bat
git add        GitHub.com/2021-08-30T1547GitHubArchive.bat
git add        IIS/WordEngineering/WordCross/TheOnlyTwoCaseThatIsGoingToSucceedAreTheCasePioneer.asmx
git add        IIS/WordEngineering/WordCross/TheOnlyTwoCaseThatIsGoingToSucceedAreTheCasePioneer.html
git add        IIS/WordEngineering/WordCross/TheOnlyTwoCaseThatIsGoingToSucceedAreTheCasePioneerArchive.asmx
git add        IIS/WordEngineering/WordCross/TheOnlyTwoCaseThatIsGoingToSucceedAreTheCasePioneerArchive.html
