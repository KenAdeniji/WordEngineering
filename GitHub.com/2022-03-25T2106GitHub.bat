        ...
        git add   IIS/WordEngineering/2018-05-03Correspondence/2022-03-24T1129ErikaWattsSexualOffenderAnnualRegistrationFremontPoliceSignForm.txt
        git add   IIS/WordEngineering/2018-05-03Correspondence/2022-03-24T1129ErikaWattsSexualOffenderAnnualRegistrationFremontPoliceSignFormArchive.txt
        git add   IIS/WordEngineering/GeoLocation/api.OpenWeatherMap.orgArchive.html
        ...
        git add   IIS/WordEngineering/WordGroup/BigInteger.asmx
        git add   IIS/WordEngineering/WordGroup/BigInteger.html
        git add   IIS/WordEngineering/WordGroup/BigIntegerArchive.asmx
