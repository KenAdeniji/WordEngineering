        ...
        git rm     IIS/WordEngineering/WordGroup/WillTargetTuesdayDecember31st.html
        git rm     IIS/WordEngineering/WordGroup/WillTargetTuesdayDecember31stArchive.html
        ...
        git add	   GitHub.com/2021-05-03T0525gitadd.bat
        git add	   GitHub.com/2021-05-03T0525gitaddArchive.bat		