        ...
        git add    IIS/Gradual/Contacts/ContactsList.aspx.cs
        git add    IIS/Gradual/UC/Contacts/ContactDisplay.ascx.cs
        git add    IIS/Gradual/UC/Contacts/ContactForm.ascx.cs
        git add    IIS/Gradual/UC/Contacts/ContactsList.ascx.cs
...
git add        GitHub.com/2021-11-06T2056GitHub.bat
git add        GitHub.com/2021-11-06T2056GitHubArchive.bat
git add        IIS/WordEngineering/Unix/
