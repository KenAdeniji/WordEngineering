...
git add        GitHub.com/2022-02-17T1742GitHub.bat
git add        IIS/WordEngineering/WordCross/HoweverWeAreThatIsWhereWeAre.asmx
git add        IIS/WordEngineering/WordCross/HoweverWeAreThatIsWhereWeAre.html
git add        IIS/WordEngineering/WordCross/HoweverWeAreThatIsWhereWeAreArchive.asmx
git add        IIS/WordEngineering/WordCross/HoweverWeAreThatIsWhereWeAreArchive.html
