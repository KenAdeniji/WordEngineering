        git add    IIS/WordEngineering/WordCross/ProperNames.asmx
...
git add       	IIS/WordEngineering/WordCross/PeopleLivingAlike.asmx
git add       	IIS/WordEngineering/WordCross/PeopleLivingAlike.html
git add       	IIS/WordEngineering/WordCross/PeopleLivingAlikeArchive.asmx
git add			IIS/WordEngineering/WordCross/PeopleLivingAlikeArchive.html
