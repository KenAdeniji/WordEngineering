...
git add "IIS/WordEngineering/Alameda County Health Agency Care Services Tri-City Community Support Center Behavioral Health Care Services/2023-03-20T1642Maureen.Orphanos@acgov.org_Abibat.Ajiboye@acgov.org_Atef.Shaikh@acgov.org.txt"
...
git add "IIS/WordEngineering/Alameda County Health Agency Care Services Tri-City Community Support Center Behavioral Health Care Services/2023-03-31T1109Maureen.Orphanos@acgov.org_Abibat.Ajiboye@acgov.org_Atef.Shaikh@acgov.org.txt"
...
git add        	IIS/WordEngineering/2018-05-03Correspondence/2023-09-22T0513WhatWeMeanToEachOther_InBetweenUs.txt
git add        	IIS/WordEngineering/CascadingStyleSheet/CSSGridLayout/
...
git add			IIS/WordEngineering/2018-05-03Correspondence/2024-04-13T1610TheGreatDechurching2024-03-13.txt
...
git add			IIS/WordEngineering/2018-05-03Correspondence/2024-06-25T2034MicrosoftOperatingSystem_MozillaFirefoxBrowser_FionaBlondPicture_RitaBusitillFriend_USbank_JoeBiden_EmmanuelMacron_Albanese.txt
...
REM git rm -f		IIS/WordEngineering/2018-05-03Correspondence/2024-07-31T2239DulhanGrocery_CharterSquare_34139FremontBoulevard_34163FremontBoulevard_Fremont_California_94555_Patel_Taruben_Ayesha.txt
...
git add	        IIS/WordEngineering/2018-05-03Correspondence/
        ...
        git add IIS/WordEngineering/Google.com_-_JobsNearMe/
        git add IIS/WordEngineering/PowerBI/
        git add IIS/WordEngineering/Resume/2024-10-08T1800linkedin.com_-_in_-_carolyneconnor.txt
        git add IIS/WordEngineering/Resume/2024-10-26T1412KenAdenijiPicture.jpg
        git add IIS/WordEngineering/Resume/2024-10-26T1434KenAdenijCaliforniaDriverLicense_-_NumberD1237383-_-Expiry2027-10-15.jpg
        git add IIS/WordEngineering/Resume/2024-10-26T1434KenAdenijCaliforniaDriverLicense_-_NumberD1237383-_-Expiry2027-10-15Back.jpg
        git add IIS/WordEngineering/Resume/KenAdenijiResume.doc
        git add IIS/WordEngineering/Web.config.bak.20020830
        git add IIS/WordEngineering/Web.config.bak.20241113.0545pm
        git add IIS/WordEngineering/WebServiceRequester/IWantToDoAReportingServiceThatGiveMeThisAbility...OrDoIWantToContinueToDoClientServer.html
        git add IIS/WordEngineering/WordEngineering.config
        git add IIS/WordEngineering/WordOfGod/2024-11-07T1917CreditabilityQuestionsURIMaintenanceWebForm.txt
        git add IIS/WordEngineering/WordOfGod/Contact.cs
        git add IIS/WordEngineering/WordOfGod/Contact.mak
        git add IIS/WordEngineering/WordOfGod/ProtocolHelper.cs
        git add IIS/WordEngineering/WordOfGod/ProtocolHelperBuild.bat
        git add IIS/WordEngineering/WordOfGod/URIBuild.bat
        git add IIS/WordEngineering/WordOfGod/URIMaintenancePage.aspx.cs
        git add IIS/WordEngineering/WordOfGod/URIMaintenancePageArchive.aspx.cs
        git add IIS/WordEngineering/WordOfGod/URIMaintenancePageRelease2016-11-11T1842.aspx.cs
        git add IIS/WordEngineering/WordOfGod/URIMaintenanceWebForm.aspx
        git add IIS/WordEngineering/WordOfGod/URIMaintenanceWebForm201102262123.aspx
        git add IIS/WordEngineering/WordOfGod/URIMaintenanceWebFormArchive.aspx
        git add IIS/WordEngineering/WordOfGod/UtilityASCII.cs
        git add IIS/WordEngineering/WordOfGod/UtilityASCIIArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityAccess.cs
        git add IIS/WordEngineering/WordOfGod/UtilityAccessArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityActiveDirectory.cs
        git add IIS/WordEngineering/WordOfGod/UtilityActiveDirectoryArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityAppDomain.cs
        git add IIS/WordEngineering/WordOfGod/UtilityAppDomainArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityAussieHomeLoansTransactionHistory.cs
        git add IIS/WordEngineering/WordOfGod/UtilityAussieHomeLoansTransactionHistoryArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityBCP.cs
        git add IIS/WordEngineering/WordOfGod/UtilityBCPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityBeep.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCOMMother.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCOMMotherArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCal.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCalArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityClass.cs
        git add IIS/WordEngineering/WordOfGod/UtilityClipboard.cs
        git add IIS/WordEngineering/WordOfGod/UtilityClipboardArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCollection.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCollectionArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityColor.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCom.cs
        git add IIS/WordEngineering/WordOfGod/UtilityComArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCommandLineArgument.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCommandLineArgumentArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCommonwealthBankOfAustraliaTransaction.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCommonwealthBankOfAustraliaTransactionArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCompress.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCompressArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityContact.cs
        git add IIS/WordEngineering/WordOfGod/UtilityContactArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityControl.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCulture.cs
        git add IIS/WordEngineering/WordOfGod/UtilityCultureArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDNS.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDNSArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDatabase.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDatabaseArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDateTime.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDateTimeArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDateTimeParse.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDateTimeXml.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDaytimePort13.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDaytimePort13Archive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDebug.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDebugArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDelegate.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDelegateArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDirectory.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDirectoryArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDiskIO.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDynamicHostConfigurationProtocolDHCP.cs
        git add IIS/WordEngineering/WordOfGod/UtilityDynamicHostConfigurationProtocolDHCPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEchoPort7Client.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEchoPort7ClientArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEchoPort7Server.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEchoPort7ServerArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEncrypt.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEncryptArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEnum.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEnumArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEnvironment.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEnvironmentArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEval.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEventLog.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEventLogArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEventLogInstallerArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEventLogSourceInstaller.cs
        git add IIS/WordEngineering/WordOfGod/UtilityEventLogSourceInstallerArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityExcel.cs
        git add IIS/WordEngineering/WordOfGod/UtilityExcelArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityException.cs
        git add IIS/WordEngineering/WordOfGod/UtilityExceptionArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFTPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFTPSubstitute.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFactorial.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFactorialArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFax.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFaxArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFibonacci.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFibonacciArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFile.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFileArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFileUpload.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFileUploadArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityFtp.cs
        git add IIS/WordEngineering/WordOfGod/UtilityGlobalization.cs
        git add IIS/WordEngineering/WordOfGod/UtilityGlobalizationArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityGoogle.cs
        git add IIS/WordEngineering/WordOfGod/UtilityGoogleArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityGraphChart.cs
        git add IIS/WordEngineering/WordOfGod/UtilityGraphChartArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityHex.cs
        git add IIS/WordEngineering/WordOfGod/UtilityHexArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityICMP.cs
        git add IIS/WordEngineering/WordOfGod/UtilityICMPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityIFormattable.cs
        git add IIS/WordEngineering/WordOfGod/Utilitygit add IISLog.cs
        git add IIS/WordEngineering/WordOfGod/Utilitygit add IISLogArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityIO.cs
        git add IIS/WordEngineering/WordOfGod/UtilityIOArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityIPAddress.cs
        git add IIS/WordEngineering/WordOfGod/UtilityIPAddressArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityIPGlobalProperties.cs
        git add IIS/WordEngineering/WordOfGod/UtilityImage.cs
        git add IIS/WordEngineering/WordOfGod/UtilityImageArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityImpersonate.cs
        git add IIS/WordEngineering/WordOfGod/UtilityImpersonateArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityIndexingService.cs
        git add IIS/WordEngineering/WordOfGod/UtilityIndexingServiceArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityInterface.cs
        git add IIS/WordEngineering/WordOfGod/UtilityInterfaceArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityInternetExplorer.cs
        git add IIS/WordEngineering/WordOfGod/UtilityJavaScript.cs
        git add IIS/WordEngineering/WordOfGod/UtilityJavaScriptArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityKernel32.cs
        git add IIS/WordEngineering/WordOfGod/UtilityKernel32Archive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityLanguage.cs
        git add IIS/WordEngineering/WordOfGod/UtilityLanguageArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMSCorEE.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMSCorEEArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMail.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMailArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityManagement.cs
        git add IIS/WordEngineering/WordOfGod/UtilityManagementArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMath.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMathArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMemory.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMemoryArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMessageQueue.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMessageQueueArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMilitaryDate.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMultiMedia.cs
        git add IIS/WordEngineering/WordOfGod/UtilityMultiMediaArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNet.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetSession.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetSessionArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetworkInformation.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetworkInformationArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetworkManagement.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetworkManagementArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetworkNewsTransferProtocolNNTP.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNetworkNewsTransferProtocolNNTPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityNumber.cs
        git add IIS/WordEngineering/WordOfGod/UtilityOleDbSchema.cs
        git add IIS/WordEngineering/WordOfGod/UtilityOleDbSchemaArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityOracle.cs
        git add IIS/WordEngineering/WordOfGod/UtilityOutlook.cs
        git add IIS/WordEngineering/WordOfGod/UtilityOutlookArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPing.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPingArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPop3.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPop3Archive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPort119NetworkNewsTransferProtocolNNTP.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPort119NetworkNewsTransferProtocolNNTPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPort19CharacterGeneratorClient.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPort19CharacterGeneratorClientArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPostback.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPostbackArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityProcess.cs
        git add IIS/WordEngineering/WordOfGod/UtilityProcessArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityProperty.cs
        git add IIS/WordEngineering/WordOfGod/UtilityPropertyArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityProtocol.cs
        git add IIS/WordEngineering/WordOfGod/UtilityProtocolArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityProtocolRelease2019-08-08.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQOTDClient.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQOTDClientArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQOTDPort17Client.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQOTDPort17ClientArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQOTDServer.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQOTDServerArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQuartz.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQuartzArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQueue.cs
        git add IIS/WordEngineering/WordOfGod/UtilityQueueArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRSS.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRSSArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityReflect.cs
        git add IIS/WordEngineering/WordOfGod/UtilityReflectArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRegistry.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRegistryArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRegularExpression.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRegularExpressionArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRequest.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRequestArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityResource.cs
        git add IIS/WordEngineering/WordOfGod/UtilityResourceArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityResponse.cs
        git add IIS/WordEngineering/WordOfGod/UtilityResponseArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRunDLL32.cs
        git add IIS/WordEngineering/WordOfGod/UtilityRunDLL32Archive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySNMP.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySNMPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLCLR.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLCLRArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLDMO.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLDMOArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLServer.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLServerArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLServerEnumerator.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLServerEnumeratorArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLServerManagementObjectsSMO.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySQLServerManagementObjectsSMOArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySecureString.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySecurityManager.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySerialization.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySerializationArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySerialize.cs
        git add IIS/WordEngineering/WordOfGod/UtilityServerManagementObjectSMO.cs
        git add IIS/WordEngineering/WordOfGod/UtilityServerManagementObjectSMOArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySimpleMailTransferProtocolSMTP.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySimpleMailTransferProtocolSMTPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySimpleMailTransferProtocolSNMP.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySimpleMailTransferProtocolSNMPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySoundPlayer.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySoundPlayerArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySpeech.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySpeechArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityStack.cs
        git add IIS/WordEngineering/WordOfGod/UtilityStackArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityString.cs
        git add IIS/WordEngineering/WordOfGod/UtilityStringArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySubnetMask.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySubnetMaskArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilitySvg.cs
        git add IIS/WordEngineering/WordOfGod/UtilityTcpIp.cs
        git add IIS/WordEngineering/WordOfGod/UtilityTcpIpArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityTemperature.cs
        git add IIS/WordEngineering/WordOfGod/UtilityTemperatureArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityThoughtWorksSalesTax.cs
        git add IIS/WordEngineering/WordOfGod/UtilityThoughtWorksSalesTaxArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityThread.cs
        git add IIS/WordEngineering/WordOfGod/UtilityThreadArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityTraceRoute.cs
        git add IIS/WordEngineering/WordOfGod/UtilityTraceRouteArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityTraceRouteNet.cs
        git add IIS/WordEngineering/WordOfGod/UtilityTraceRouteNetArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityURI.cs
        git add IIS/WordEngineering/WordOfGod/UtilityURI.mak
        git add IIS/WordEngineering/WordOfGod/UtilityURIArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityURIArchive.mak
        git add IIS/WordEngineering/WordOfGod/UtilityURIBuild.bat
        git add IIS/WordEngineering/WordOfGod/UtilityURIBuildArchive.bat
        git add IIS/WordEngineering/WordOfGod/UtilityURIRelease2016-11-11T2036.mak
        git add IIS/WordEngineering/WordOfGod/UtilityUnicode.cs
        git add IIS/WordEngineering/WordOfGod/UtilityUnicodeArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityUnicodePage.aspx.cs
        git add IIS/WordEngineering/WordOfGod/UtilityUnicodePageArchive.aspx.cs
        git add IIS/WordEngineering/WordOfGod/UtilityUser.cs
        git add IIS/WordEngineering/WordOfGod/UtilityUserArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWakeOnLan.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWakeOnLan.cs.bak
        git add IIS/WordEngineering/WordOfGod/UtilityWakeOnLanArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWav.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWavArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWebControl.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWebControlArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWhoIsArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWhoIsPort43.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWhoIsPort43Archive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWin32Window.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWin32WindowArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWindowsManagementInstrumentationWMI.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWindowsManagementInstrumentationWMIArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWindowsMediaPlayerWMP.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWindowsMediaPlayerWMPArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWinmm.cs
        git add IIS/WordEngineering/WordOfGod/UtilityWinmmArchive.cs
        git add IIS/WordEngineering/WordOfGod/UtilityXml.cs
        git add IIS/WordEngineering/WordOfGod/UtilityXmlArchive.cs
        git add IIS/WordEngineering/bin/ContactMaintenancePage.aspx.cs.dll
        git add IIS/WordEngineering/bin/ContactMaintenancePage.aspx.cs.pdb
        git add IIS/WordEngineering/bin/ProtocolHelper.dll
        git add IIS/WordEngineering/bin/URIMaintenancePage.aspx.cs.dll
        git add IIS/WordEngineering/bin/URIMaintenancePage.aspx.cs.pdb
        git add IIS/WordEngineering/bin/UriHelper.dll
        git add IIS/WordEngineering/bin/UrlHelper.dll
        git add IIS/WordEngineering/bin/UtilityPostback.dll
        git add IIS/WordEngineering/bin/UtilityWebControl.dll
...
git add		IIS/WordEngineering/2018-05-03Correspondence/2025-03-20LucyMacbryde_lucy@westside.net.au_2025-03-20AlbertsonsLuckyCharterSquare_MikeTewksbury_Kellogg5_2025-03-21HeathrowAirport2025-03-25MicrosoftBaselineStudies.txt

git add		InformationInTransit/ProcessCode/APerhapsCompareHelper.cs
