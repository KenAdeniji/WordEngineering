...
{
	public static partial class TransactSQLCookbookByAlesSpetic_JonathanGennick_PivotTable
	{
...
SELECT 
	CONVERT(char(10), DATEADD(d, i * {6}, CURRENT_TIMESTAMP), 121) Date,
	DATENAME(dw, DATEADD(d, i * {6}, CURRENT_TIMESTAMP)) Day
