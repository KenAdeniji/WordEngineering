...
namespace InformationInTransit.ProcessCode
{
	/*
		...
		2018-12-18	https://craigwatson1962.wordpress.com/2010/12/01/linq-over-fileinfo-and-using-let-for-clarity/
		...
		)
		{
			...
			IEnumerable<FileInfoRecord> queryMatchingFiles =  
				...
				select new FileInfoRecord
				{
					...
					CreationTime = file.CreationTime.Round(DateTimeHelper.RoundTo.Second),
					LastWriteTime = file.LastWriteTime.Round(DateTimeHelper.RoundTo.Second),
					Length = file.Length,
