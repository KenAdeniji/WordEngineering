...
{
	/*
		2021-02-02T16:42:00 ... 2021-02-02T17:06:00	Created.	That is why, we are today? To seem tomorrow, forever.
	*/
    public static partial class ThatIsWhyWeAreTodayToSeemTomorrowForever
    {
		...
		@"
			SELECT 
				BookID, BookTitle, COUNT(*) AS Occurrences
				FROM {0}
				WHERE {1} 
