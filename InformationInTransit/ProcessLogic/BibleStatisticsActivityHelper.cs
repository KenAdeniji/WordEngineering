...
{
    /*
        2016-06-12	BibleStatisticsActivityHelper.cs 		Created.
    ...
    */
    public static partial class BibleStatisticsActivityHelper
    {
		...
		public static readonly string[][] Activities = new string[4][] 
		{ 
			new string[] {"Move", "Moved", "Moving"},
			new string[] {"Say", "Said", "Saying"},
			new string[] {"Divide", "Divided", "Dividing"},
			new string[] {"Rest", "Rested", "Resting"},
		};		

        public const string BibleStatisticsActivitiesQueryFormat = " SELECT " +
			" COUNT(*) AS VerseCount, " +
			" '{1}' AS Words, " +			
			" (SELECT scriptureReference FROM Bible..Scripture_View WHERE verseIdSequence = (SELECT MIN(verseIdSequence) FROM Bible..Scripture WHERE {0})) AS FirstScriptureReference, " +
        ...
        public const string BibleStatisticsActivitiesOrderByFormat = " ORDER BY Words";
