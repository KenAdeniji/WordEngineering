...
exec sp_grantlogin 'ephraimtech\ephwebUser'
go

use security
go

exec sp_grantdbaccess 'ephraimtech\ephwebUser', ephwebUser
go

grant exec on usp_getMemberID to ephWebUser
go
...
exec sp_addrolemember roleFullUsage, ephwebUser
go
...
grant select on dbo.support_profession to roleFullUsage
go
