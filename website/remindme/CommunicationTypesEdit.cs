namespace EphraimTech.RemindME
{
    ...
    public class frmCommunicationTypesEdit : System.Web.UI.Page
    {
	   ...
	   protected CheckBox chkIsWebSite;	
       ...
       private void getCommunicationTypeInfo()
       {
			...
			String          strIsWebSite = null;
			Boolean         bIsWebSite = false;
			
            String          strCommunicationType = null;
            int             iCommunicationType = -1;
							
			strSQLQuery = "[dbo].[usp_CommunicationTypeGet]";
            ...
            while (objDBReader.Read())
            {
				...
				strIsWebSite = objDBReader["IsWebSite"].ToString();
            ...
            chkIsWebSite.Checked = bIsWebSite;                        
        ...
        protected Boolean DBSaveInternal(Boolean bInserting)
        {
			...
			int iCommunicationTypeIsWebSite =-1;
            ...
            try
			{
				...
				strSQL = "[dbo].[usp_CommunicationTypeSave]";
				...
				if (chkIsWebSite.Checked == true)
				{
					iCommunicationTypeIsWebSite = 1;
				}   
				else                        
				{
					iCommunicationTypeIsWebSite = 0;
				}    
				...
				//iCommunicationTypeIsWebSite
				OleDbParameter objDBParameterIsWebSite = new OleDbParameter();
				objDBParameterIsWebSite.ParameterName = "IsWebSite";
				objDBParameterIsWebSite.OleDbType = OleDbType.Integer;
				objDBParameterIsWebSite.Value = iCommunicationTypeIsWebSite;
				objDBCommand.Parameters.Add(objDBParameterIsWebSite);                                                    
