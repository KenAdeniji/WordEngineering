namespace PeopleSoft.ITDBA.reportWriter
{
    ...
    public class frmReportMS : System.Web.UI.Page
    {
       ...
       protected Boolean readConfigurationSettings()
       {
            ...
            strSQLGetReports = ConfigurationSettings.AppSettings["SQLGetMSReportServicesReports"];            
            ...
            {
				LabelInfo.Text = 
					"ConfigurationSettings.AppSettings['SQLGetMSReportServicesReports'] returned null";
       ...
       private void getBody()
       {
            ...
            {   
                ...
                if (bOK == false)
                {
                	LabelDebug.Text = "populateReportCombobox() failed "
       ...
       private Boolean populateReportCombobox()
       {
			...
			String  strDropDownCB;
			
       		strDropDownCB = PeopleSoft.ITDBA.reportWriter.reportID.REPORT_DROPDOWNID_ID_REPORTSERVICES.ToString();
			
			bDataReturned = populateCombobox( 
											    strDropDownCB
											  , cbReportID
							    			  , strSQLGetReports
											);
      ...
      protected Boolean processSelectedReport()
      {
		...
		catch (Exception ex)
		{
      	...
      	//labelTrail.Text = "Calling tagSelectedReport with "
		//					+ iSelectedItemValue;
							
      	bOK = tagSelectedReport(iSelectedItemValue, iSelectedIndex);
		
		//labelTrail.Text += "In processSelectedReport()::tagSelectedReport after " 
		//						+ objLogError.ToString();
      	...
      	try
      	{
			...
			labelTrail.Text = "";
      		...
      		if (bOK == false)
      		{
				...
				labelTrail.Text += "objReportType.queryReportInfo(iReportID) returned error as "
                                     + objLogError.ToString();
			...
			{
				//labelTrail.Text += "objReportType.queryReportInfo(iReportID) returned passed.  "
				//                     + "Error log is "
                //                     + objLogError.ToString()  + "<BR>";			
									 
				//labelTrail.Text += 	"RepName is " + objReportType.reportName + "<BR>";
				
				//labelTrail.Text += 	"RepURL is " + objReportType.MSReportServicesURL + "<BR>";
				
				
			}
		
		
			//labelTrail.Text += "Report Type is " + objReportType.ToString();			
...
*/			
			...
			//objReportTypeShell = (reportType) objListReports[iSelectedIndex];
			
			objReportTypeShell = (reportType) objListReports[iSelectedIndex];			
      		
/*			
			labelTrail.Text += 	"objReportTypeShell -- RepName is " 
									+ objReportTypeShell.reportName + "<BR>";
									
			labelTrail.Text += 	"objReportTypeShell -- RepURL is " 
									+ objReportTypeShell.MSReportServicesURL + "<BR>";
...
*/									
			...
			//labelTrail.Text += "Report Shell Name is " + objReportType.reportName + "<BR>";
			//labelTrail.Text += "Report Shell SQL is " + objReportType.reportSQL + "<BR>";
			//labelTrail.Text += "Report Shell URL is " + objReportType.MSReportServicesURL + "<BR>";			
            ...
            objLog.Append(
							"tagSelectedReport::reportType::getReportParameters() -- " 
                           + "Number of parameters in shell is " 
						   + objReportTypeShell.parameterList.Count + "  "
                           + "Parameter list count in copy is " + iNumberofParameters
						   );

      		
			//labelTrail.Text += "Preparing to check parameters";
      			 ...
      			 iParameterIndex++)
      		{
                ...
                objLog.Append("tagSelectedReport::Iterating parameter list -- " 
      			...
      			objTextBox = (System.Web.UI.WebControls.TextBox) 
								findControlBasedOnPosition(
															iParameterIndexAdjusted
								                           , CONTROL_TYPE_TEXTBOX
														   );    			                                        
      			
      			objDropDown = (System.Web.UI.WebControls.DropDownList) 
								findControlBasedOnPosition(
															iParameterIndexAdjusted
      			...
      			if (objParameter.parameterIsSystem)
      			{
					...
					if (bParameterValueFilled == false)
					{
						...
						objLogError.Append("parameter name is " + objParameter.parameterName + " " +
					              		   ...
					              		   "Session parameter as sysparm is "
										   + objParameter.parameterNameAsSystemParameter + " " +
			...
			//return (false);
      		...
      		if (bOK == false)
      		{
				...
				//labelTrail.Text += " objReportType.validateReportParameters();  failed";
								
				return(bOK);
      		}      		
      		
			//labelTrail.Text += " objReportType.validateReportParameters();  passed";
			...
			//LabelDebug.Text = (Session[strReportOption]).ToString();
			//LabelDebug.Visible = true;			
		...
		catch (Exception ex)
		{
			...
			strLog = "In reportTopMS::Exception in tagSelectedReport " + ex.Message;
