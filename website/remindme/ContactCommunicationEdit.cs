namespace EphraimTech.RemindME
{
	...
	*/
    ...
    public class frmContactCommunicationEdit : System.Web.UI.Page
    {
	   ...
	   protected TextBox txtCommunicationLink;
       ...
       private int iCommunicationType = -1;
       private String strCommunicate = null;
       private String strComment = null;
	   private String strCommunicationLink = null;
       ...
       private void getContactCommunicationInfo()
       {
			...
			strSQLQuery = "[dbo].[usp_getContactCommunicationRecord]";
            ...
            while (objDBReader.Read())
            {
				...
				txtCommunicationLink.Text = objDBReader["CommunicationLink"].ToString();
        ...
        protected Boolean DBSave()
        {
			...
			strCommunicationLink = txtCommunicationLink.Text;
        ...
        protected Boolean DBUpdate()
        {
            ...
            try
			{
				...
				strSQLBuilder.Append(" exec " + "" + "[dbo].[usp_ContactCommunicationUpdate] " + " " );
				strSQLBuilder.Append(" ?, ?, ?, ?, ?, ? ");
				strSQL = strSQLBuilder.ToString();				
				
				*/
				strSQL = "[dbo].[usp_ContactCommunicationUpdate]";
				...
				OleDbParameter objDBParameterCommunicationLink = new OleDbParameter();
				objDBParameterCommunicationLink.ParameterName = "CommunicationLink";
				objDBParameterCommunicationLink.OleDbType = OleDbType.VarChar;
				if (strCommunicationLink == String.Empty)
				{
					objDBParameterCommunicationLink.Value = DBNull.Value;
				}							
				else	
				{
					objDBParameterCommunicationLink.Value = strCommunicationLink;
				}		
				objDbCommand.Parameters.Add(objDBParameterCommunicationLink);                            				
        ...
        protected Boolean DBInsert()
        {
			...
			*/
			...
			/*
				...
				strSQLBuilder.Append(" exec " + "" + "[dbo].[usp_ContactCommunicationInsert] " + " " );                                        
				strSQLBuilder.Append(" ?, ?, ?, ?, ?, ?, ? ");
			...
			*/
			...
			strSQL = "[dbo].[usp_ContactCommunicationInsert]";
