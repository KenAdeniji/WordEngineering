...
namespace PeopleSoft
{
	...
	public class ADHelper
	{
		...
		public static DataSet GetUsersForGroup(string GroupName)
		{
			...
			int iUserAccountControl = -1;
			//String strAccountActive;
			bool bIsAccountActive = false;
			...
			//tbUser.Columns.Add("Is Account Active");
			...
			if(results !=null)
			{
				...
				for (int l = 0; l < n ; l++)
				{
					//create a link to the user object sot hat the FirstName, LastName and SUername can be gotten
					 ...
					 iUserAccountControl = Convert.ToInt32(GetProperty(deUser,"userAccountControl"));
					 bIsAccountActive = IsAccountActive(iUserAccountControl);					 
...
*/						
						//rwUser["Is Account Active"]= strAccountActive;					
