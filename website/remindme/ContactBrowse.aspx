                    ...
                    <TABLE 
                       ...
                       <TR>
                            ...
                            <TD align='left'>                                                                                                                                                            
                                    ...
                                    <asp:TextBox 
                                     ID="txtContactMinorSearchTag" 
                                     maxlength="30"
                                     RunAt="server" 
									 />

								  <asp:ImageButton 
									id="idAnchorContactMinorSearch" 
									runat="server"
                                 ...
                                 <columns>
								  ...
								  <ItemTemplate>
									  ...
									  <center>
							              	...
							              	<a href='<%#"DBUpdate.aspx?DBItemType=CommunicationItemCopy"
											
											+ "&ContactID="
											+ DataBinder.Eval(Container.DataItem, "contactIdentifier")
											
											+"&CommunicationID=" 
											+ DataBinder.Eval(Container.DataItem,"communicationIdentifier")
											...
											%>'>														
											<img 
												src='images/duplicate.gif' border=0
											>
									...
									<asp:TemplateColumn 
							            ...
							            <ItemTemplate>
							              <center>
							              	...
							              	<a href='<%#"DBUpdate.aspx?DBItemType=CommunicationItemActivateToggle"
									...
									<asp:TemplateColumn HeaderText="Delete"
							            ...
							            <ItemTemplate>
							              <center>
							              	...
							              	<a href='<%#"DBUpdate.aspx?DBItemType=CommunicationItemDelete"
                              ...
                              <asp:DataGrid 
                                 ...
                                 <columns>
									...
									<asp:TemplateColumn
    		                         ...
    		                         <asp:BoundColumn 
   		                             ...
   		                             <asp:HyperLinkColumn 
                                	        ...
                                	        Text="Copy" 
    		                                DataNavigateURLField="eventIdentifier"
    		                                DataNavigateURLFormatString="ContactEventCopy.aspx?ContactEventID={0}"
       		                                Visible="False"
    		                                > 	
   		                            </asp:HyperLinkColumn>   									
									...
									<asp:TemplateColumn 
							            ...
							            <ItemTemplate>
							              <center>
							              	<a href='<%#"ContactEventCopy.aspx?ContactID="+ DataBinder.Eval(Container.DataItem, "contactIdentifier")+"&ContactEventID=" + DataBinder.Eval(Container.DataItem, "eventIdentifier")%>'>
							                <img src='images/duplicate.gif' border=0>
							                </a>
							              </center>
							            </ItemTemplate>
								...
								<asp:TemplateColumn HeaderText="Delete"
									...
									<ItemTemplate>
									  <center>
										<a onclick="return confirm(&quot;Are you sure you want to make a delete this entry ?&quot;);" 
										   href='<%#"DBUpdate.aspx?DBItemType=EventItemDelete"+"&ContactID="+ DataBinder.Eval(Container.DataItem, "contactIdentifier")+"&ContactEventID=" + DataBinder.Eval(Container.DataItem, "eventIdentifier")&DBItemEntryID=" + DataBinder.Eval(Container.DataItem, "eventIdentifier")%>'>
										<img src='images/close.gif' border=0>
										</a>
									  </center>
									</ItemTemplate>
