...
<script language='javascript'>
    ...
    function generateReport(iChkInaNewWindow, strReportType)
    {
        ...
        if ((strReportID != null) && (strReportID != ''))
        {
            ...
            strURLDestination = "reportExcel.aspx";
     ...
     <tr><td> 
      ...
      <form id='frmReport' 
        ...
        <TR>
            ...
            <A href="javascript:void(0)" onclick="window.parent.bottom.focus(); print();">
                <IMG alt="print page" border=0  src="..\images\Printer\printer.jpg">                
            </A>
