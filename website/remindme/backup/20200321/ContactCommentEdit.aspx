...
<%@ Page
	...
	Language="c#" 
        src="ContactCommentEdit.cs" 
        Inherits="EphraimTech.RemindME.frmContactCommentEdit" 
            ...
            <TR VALIGN='top'>
                ...
                <TD  VALIGN='top' align="left" width="20%">
					...
					<td VALIGN='top' align="left" width="80%">
                        ...
                        <TABLE cellpadding='0' border='0' cellspacing='2'  width='60%'>    
                            
                                <form  id=frmCommunicationEdit 
                                       method="post" 
                                       runat="server">
                                       
                                    <input id="hiddenContactCommentID" type=hidden runat="server">                                       
