namespace EphraimTech
{
    ...
    public class SupportProfessions : System.Web.UI.Page
    {
       ...
       protected void GridUpdate(Object sender, DataGridCommandEventArgs e)
       {
                                   ...
                                   String strSubject)
        {
            ...
            strSQLBuilder.Append("usp_ProfessionUpdate");                                        
                                   ...
                                   String strSubject)
        {
            ...
            strSQLBuilder.Append("usp_ProfessionInsert");                                        
