...
2021-06-18T16:14:00 800 Service 1-800-991-8708
	...
	or press two and your eligibility to lower your interest will expire.
2021-06-23T13:07:00
My name is Vijeta Tripathi, Recruiter with Infotree Global Solutions (www.infotreeglobal.com). We are a Workforce Solutions company providing staffing solutions to clients globally, some of the clients being large Fortune 500 companies. I came across your resume on one of the Job Boards. One of our direct clients is exclusively hiring for " Software Systems Engineer/Software Developer III” in Cupertino, CA 95014  

 

 

Below I am sharing the detailed Job Description for your review, if the job description is in line with what you are looking for; Please send me an updated copy of resume in MS Word Format. I am also going to try calling you on the number provided on the resume. If we don’t connect, please let me know what a good time to talk and if there is a different number to reach you. Alternatively, please call me at (734) 656-8749
...
Job Posting Title:           Software Systems Engineer/Software Developer III
...
• Develop the control and UI software for next generation platform on automated test and inspection.

 

Qualification:

• Minimal 6 years of software development experience with C#/.Net or C++ on equipment or instrument control or related.

• Proficient experience on UI programming using WPF/C#.

• Solid programming experience on multi-threading and strong software/hardware integration experience.

• Strong experience on OOD and OOP is highly preferable.
...
Sr. Technical Recruiter -  Infotree Global Solutions

Email Id :  Vijeta@infotreeglobal.com

Phone: (734) 656-8749

Website: www.infotreeglobal.com
